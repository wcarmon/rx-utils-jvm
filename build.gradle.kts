...
val mvnArtifactId = "rx-utils-jvm" // see settings.gradle.kts
...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                name = mvnArtifactId
                description = "Utilities for using RxJava"
                url = "https://github.com/wcarmon/rx-utils-jvm"

                licenses {
                    license {
                        name = "MIT License"
                        url =
                            "https://raw.githubusercontent.com/wcarmon/rx-utils-jvm/main/LICENSE"
                    }
                }
                ...
                scm {
                    connection =
                        "scm:git:git@github.com:wcarmon/rx-utils-jvm.git"
                    developerConnection =
                        "scm:git:ssh://github.com:wcarmon/rx-utils-jvm.git"
                    url = "https://github.com/wcarmon/rx-utils-jvm/tree/main"
                }
            }
        }
    }
